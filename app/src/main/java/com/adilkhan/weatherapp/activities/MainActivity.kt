package com.adilkhan.weatherapp.activities

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import com.adilkhan.weatherapp.R
...
import com.adilkhan.weatherapp.models.WeatherResponse
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getUnit(): String {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            value = application.resources.configuration.locales[0].country.toString()

        }else{

            value = application.resources.configuration.locale.country.toString()
